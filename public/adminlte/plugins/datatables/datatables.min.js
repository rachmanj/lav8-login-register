...
(function (k) {
    ...
    u.ext = L = {
        buttons: {},
        classes: {},
        builder: "dt/dt-1.10.25/fh-3.1.9",
        errMode: "alert",
        feature: [],
        search: [],
    ...
    e.extend(l.prototype, {
        ...
        _clone: function (a, b) {
            ...
            !b && c.floating
                ...
                : (c.floating &&
                      ...
                      c.floating.remove()),
                  (c.floating = e(d.table().node().cloneNode(!1))
        ...
        _unsize: function (a) {
            ...
            b && ("footer" === a || ("header" === a && !this.s.autoWidth))
                ? e("th, td", b).css({ width: "", minWidth: "" })
                : b && "header" === a && e("th, td", b).css("min-width", "");
        },
        _horizontal: function (a, b) {
            ...
            d.floating &&
                f[a] !== b &&
                (d.floating.css("left", c.left - b), (f[a] = b));
        },
        _modeChange: function (a, b, d) {
            ...
            "in-place" === a
                ? (c.placeholder &&
                  ...
                  this._unsize(b),
                  "header" === b ? c.host.prepend(q) : c.host.append(q),
                  c.floating && (c.floating.remove(), (c.floating = null)))
                : "in" === a
                ? (this._clone(b, d),
                  c.floating
        ...
        _positions: function () {
            ...
            f.length
                ...
                : ((b.tfootTop = b.tbodyTop + d.outerHeight()),
...
(function (c) {
    "function" === typeof define && define.amd
        ...
        ? (module.exports = function (a, b) {
              ...
              b.fn.dataTable.FixedHeader ||
                  require("datatables.net-fixedheader")(a, b);
              return c(b, a, a.document);
          })
        : c(jQuery, window, document);
})(function (c, a, b, d) {
