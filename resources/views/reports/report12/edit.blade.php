      ...
      <div class="col-10">
        <div class="card">
          <div class="card-header">
            ...
            <a href="{{ route('reports.report12.index') }}" class="btn btn-sm btn-primary float-right"><i class="fas fa-undo"></i> Back</a>
          </div>
          <div class="card-body">
            <dl class="row">
    ...
    <div class="modal fade" id="modal-upload">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="{{ route('reports.report12.update', $invoice->inv_id) }}" enctype="multipart/form-data" method="POST">
            @csrf @method('PUT')
