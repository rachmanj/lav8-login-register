  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <a href="{{ route('accounting.lpd.index') }}" class="btn btn-sm btn-primary">Back</a>
        <a href="{{ route('accounting.lpd.lpd_view_pdf', $lpd->id) }}" class="btn btn-sm btn-success" target="_blank">View PDF</a>
      </div>
      <div class="card-body">
