  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Outstanding ITOs for Project <b>{{ auth()->user()->project->project_code }}</b></h3>
...
<div class="modal fade" id="update-many">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="{{ route('logistic.site-monitoring.update_many') }}" method="POST">
        @csrf
...
<script>
  $(function () {
    $("#example1").DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ route('logistic.site-monitoring.data') }}',
      columns: [
        {data: 'DT_RowIndex', orderable: false, searchable: false},
        {data: 'document_no'},
        {data: 'document_date'},
        {data: 'delivery_date'},
        {data: 'from_warehouse', orderable: false, searchable: false},
        {data: 'doktams_po_no'},
        {data: 'ta_no'},
        {data: 'days'},
